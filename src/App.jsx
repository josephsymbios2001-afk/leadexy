...
export default function App() {
  ...
  return (
    <div style={{fontFamily:"Arial",background:"#f7f4ef",padding:"40px",textAlign:"center"}}>
      ...
      <p>We generate qualified B2B leads and book decision-maker meetings.</p>
      ...
      <form
        ...
        style={{maxWidth:"400px",margin:"20px auto",display:"flex",flexDirection:"column",gap:"10px"}}
      >
        <input name="name" placeholder="Name" required />
        <input name="email" placeholder="Email" required />
        <textarea name="message" placeholder="Message" required />
        <button style={{background:"#ff7a00",color:"#fff",padding:"10px"}}>
          Send Message
        </button>
      </form>
    </div>
